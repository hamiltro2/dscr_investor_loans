...
// The section to remove starts at {/* Hero Section */} and ends just before {/* Disclosure Modal */}
const heroStartIdx = content.indexOf('{/* Hero Section */}');
const disclosureStartIdx = content.indexOf('{/* Disclosure Modal */}');

// The section to remove starts at {/* Form Section */} and ends just before {/* AI Optimized Content
const formStartIdx = content.indexOf('{/* Form Section */}');
const aiStartIdx = content.indexOf('{/* AI Optimized Content - Hidden but readable by Google AI */}');

if (heroStartIdx === -1 || disclosureStartIdx === -1 || formStartIdx === -1 || aiStartIdx === -1) {
  console.log('Could not find all sections to replace');
  process.exit(1);
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 text-center lg:text-left">
              <div>
                ...
                <p className="text-xl text-emerald-100/90 font-light max-w-lg mx-auto lg:mx-0">
              ...
              <div className="flex flex-col space-y-4">
                <div className="inline-flex flex-wrap gap-4 items-center justify-center lg:justify-start">
              ...
              {/* YouTube Video with Brian */}
              <div className="relative pt-6 rounded-2xl overflow-hidden shadow-2xl border border-white/10 group max-w-md mx-auto lg:mx-0">
                ...
                <div className="relative aspect-video rounded-xl overflow-hidden bg-dark-900 border border-white/5">
                  <iframe 
                  ...
                  <div className="absolute top-0 left-0 w-full p-4 bg-gradient-to-b from-black/60 to-transparent pointer-events-none">
                    <span className="text-white text-sm font-medium drop-shadow-md">Hear from Brian in Southern California</span>
                  </div>
                </div>
              </div>
            ...
            <div className="relative w-full max-w-xl mx-auto lg:mr-0 z-10 transition-transform duration-500 ease-in-out hover:-translate-y-1 mt-8 lg:mt-0">
...
const middlePart = content.slice(disclosureStartIdx, formStartIdx);
const bottomPart = content.slice(aiStartIdx);

const newContent = topPart + newHero + middlePart + bottomPart;
