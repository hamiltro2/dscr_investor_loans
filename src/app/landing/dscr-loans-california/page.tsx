    ...
    try {
      const response = await fetch('/api/send-email', {
        ...
        body: JSON.stringify({
          ...
          data: {
            ...formData,
            loanType: 'DSCR Loan (California Landing)',
            source: 'Landing Page - DSCR California',
            message: `Lead submitted from California DSCR landing page.`
          }
        })
      });
              ...
              {isSuccess ? (
                <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-8 text-center h-full flex flex-col justify-center items-center">
                  ...
                  <p className="text-gray-300 text-lg">
                    Thank you, {formData.name.split(' ')[0]}. We have received your request and our California loan experts will contact you shortly at {formData.phone}.
                  </p>
                </div>
              ) : (
