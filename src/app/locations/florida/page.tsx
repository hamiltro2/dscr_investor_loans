...
export default function FloridaPage() {
  const cities = [
    ...
    'Fort Myers', 'Boca Raton', 'Gainesville', 'Tallahassee', 'Pensacola'
  ];
  ...
  const loanTypes = [
    ...
    { name: 'Vacation Rental Financing', description: 'Airbnb and short-term rental properties' }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Specialized DSCR loans and investment property financing throughout the Sunshine State. 
              Fast approvals, competitive rates, and expertise in Florida's hot rental markets.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  <p className="flex items-start gap-3">
                    ...
                    <span>
                      Statewide coverage from Miami to Jacksonville<br />
                      Expertise in vacation rental markets
                    </span>
                  </p>
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-4">
                  Why Choose Capital Bridge Solutions in Florida?
                </h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">Deep understanding of Florida's vacation rental and long-term rental markets</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">Fast approvals for Airbnb, VRBO, and traditional rentals</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">Expertise in condo financing and HOA requirements</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">Competitive rates for Florida's booming real estate market</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">
              Serving All Major Florida Markets
            </h2>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">
              Investment Loan Products for Florida
            </h2>
