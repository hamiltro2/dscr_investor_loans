...
export default function NevadaPage() {
  ...
  const loanTypes = [
    ...
    { name: 'Vacation Rental Financing', description: 'Las Vegas short-term rental properties' }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Real Estate Investment Loans in Nevada
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Specialized DSCR loans and investment property financing throughout the Silver State. 
              Fast approvals, competitive rates, and expertise in Nevada's growing rental markets.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  <p className="flex items-start gap-3">
                    ...
                    <span>
                      Statewide coverage from Las Vegas to Reno<br />
                      Expertise in vacation and long-term rentals
                    </span>
                  </p>
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-4">
                  Why Choose Capital Bridge Solutions in Nevada?
                </h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">Deep understanding of Nevada's unique rental markets and regulations</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">Fast approvals for Las Vegas vacation rentals and Reno properties</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">No state income tax means better cash flow for investors</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">Competitive rates for Nevada's expanding real estate market</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">
              Serving All Major Nevada Markets
            </h2>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">
              Investment Loan Products for Nevada
            </h2>
          ...
          <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl p-12 text-center">
            <h2 className="text-3xl font-bold text-white mb-6">
              Ready to Finance Your Nevada Investment Property?
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a 
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-primary-600 transition-colors"
              >
