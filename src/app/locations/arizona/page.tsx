        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Real Estate Investment Loans in Arizona
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Specialized DSCR loans and investment property financing throughout the Grand Canyon State. 
              Fast approvals, competitive rates, and expertise in Arizona's thriving rental markets.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  <p className="flex items-start gap-3">
                    ...
                    <span>
                      Statewide coverage from Phoenix to Tucson<br />
                      Expertise in Arizona's fast-growing markets
                    </span>
                  </p>
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-4">
                  Why Choose Capital Bridge Solutions in Arizona?
                </h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">Deep understanding of Arizona's explosive population and rental growth</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">Fast approvals for Phoenix metro and emerging markets</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">Expertise in new construction and value-add properties</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">Competitive rates for one of America's hottest real estate markets</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">
              Investment Loan Products for Arizona
            </h2>
