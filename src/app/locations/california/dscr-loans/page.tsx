            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto">
                  ...
                  <span className="text-primary-400 font-semibold"> Rates from 5.5%</span> • Close in 10-15 days
                </p>
              ...
              <div className="flex flex-wrap gap-4 mb-12 border-b border-white/10 pb-4">
                {[
                  ...
                  <button
                    ...
                    className={`px-6 py-3 rounded-xl font-semibold transition-all duration-300 inline-flex items-center gap-2 ${activeTab === tab.id
