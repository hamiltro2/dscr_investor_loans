          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <BlogImage
                ...
                height={630}
                priority={true}
                caption="DSCR Loan Rates from 5.5% - Get the best rates for your California investment property"
              />
              ...
              <div className="prose prose-invert max-w-none">
                <p className="text-xl text-gray-300 mb-8">
                  DSCR loan rates in California currently start as low as 5.5%, influenced by factors like
                ...
                <table className="w-full bg-dark-800/50 backdrop-blur-sm rounded-xl overflow-hidden border border-primary-500/20">
                  ...
                  <tbody className="text-gray-300">
                    <tr className="border-t border-gray-700">
                      ...
                      <td className="py-4 px-6 text-center">5.5%</td>
