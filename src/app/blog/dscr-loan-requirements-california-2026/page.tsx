...
export default function DSCRRequirementsPage() {
  return (
    <>
      <ArticleSchema
        headline="DSCR Loan Requirements California 2026: What You Need to Know"
        description="Complete breakdown of 2026 DSCR loan requirements in California. Credit scores from 620, down payments from 20%, and no tax returns needed."
        ...
        url="https://www.capitalbridgesolutions.com/blog/dscr-loan-requirements-california-2026"
      />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <nav className="flex items-center gap-2 text-sm text-gray-400 mb-8">
                ...
                <span>/</span>
                <span className="text-white">DSCR Loan Requirements 2026</span>
              </nav>

              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                DSCR Loan Requirements California 2026: What You Need to Know
              </h1>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-invert max-w-none">
                <p className="text-xl text-gray-300 mb-8">
                  DSCR loan requirements in California have evolved significantly in 2026, offering more
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl font-bold text-white mb-8 text-center">
                Core DSCR Loan Requirements for 2026
              </h2>
