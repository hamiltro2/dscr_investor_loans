...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Complete guide to current DSCR loan rates in California starting at 5.99%. Rate tables, factors affecting pricing, and strategies to get the best rate.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'DSCR Loan Rates California 2025 - Current interest rates starting at 5.99%',
      },
    ],
    locale: 'en_US',
    type: 'article',
