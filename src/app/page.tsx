      ...
      <section className="relative isolate pt-14 pb-10 overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <img 
            ...
            className="w-full h-full object-cover object-center brightness-[0.70] scale-105"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-dark-950/50 via-dark-950/15 to-dark-950/95" />
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <Link href="/blog/best-lenders-self-employed-california" className="bg-gradient-to-br from-primary-500/10 to-primary-600/10 border border-primary-500/40 rounded-xl p-6 hover:border-primary-500/60 transition-all duration-300 group">
                ...
                <p className="text-gray-400 text-sm mb-4">Compare top 10 lenders for self-employed borrowers. Bank statement loans, DSCR, and no-doc options. Rates from 5.9%.</p>
