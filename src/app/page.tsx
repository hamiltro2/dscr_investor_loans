                  ...
                  <div className="pt-6 flex flex-col sm:flex-row gap-4 items-center justify-center">
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-xs text-emerald-300/90">Get instant loan guidance</div>
                      </div>
                      <svg className="w-4 h-4 text-emerald-400/60 group-hover:text-emerald-400 group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group relative inline-flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-white/20 hover:border-white/40 transition-all duration-300 shadow-lg hover:shadow-xl"
                    >
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-xs text-white/70">Analyze properties instantly</div>
                      </div>
