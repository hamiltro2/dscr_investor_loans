...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    '/faq',
    '/faq/calculate-dscr-rental-property',
    '/faq/credit-score-for-dscr-loan',
    '/faq/current-dscr-loan-rates',
    '/faq/do-dscr-loans-require-tax-returns',
    '/faq/dscr-loan-bad-credit',
    '/faq/dscr-loan-requirements',
    '/faq/dscr-loan-self-employed',
    '/faq/dscr-vs-conventional-loan',
    '/faq/how-does-dscr-loan-work',
    '/faq/what-is-a-dscr-loan',
    '/faq/what-is-dscr-in-real-estate',
    '/faq/what-is-good-dscr-ratio',
    '/investor',
    '/partner-network',
    '/privacy',
    '/privacy-policy',
    ...
    '/locations/arizona',
    '/locations/nevada',
    '/locations/anaheim-dscr-loans',
    '/locations/berkeley-dscr-loans',
    '/locations/fremont-dscr-loans',
    '/locations/irvine-dscr-loans',
    '/locations/long-beach-dscr-loans',
    '/locations/los-angeles-dscr-loans',
    '/locations/oakland-dscr-loans',
    '/locations/palo-alto-dscr-loans',
    '/locations/san-diego-dscr-loans',
    '/locations/san-francisco-dscr-loans',
    '/locations/san-jose-dscr-loans',
    '/locations/santa-clara-dscr-loans',
    '/landing/dscr-loans',
    '/landing/dscr-loans-california',
    '/landing/self-employed-investment-loans',
    '/blog',
    // All blog articles
